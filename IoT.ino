...
#define TX 2
#define RX 3
#define dht_apin 11 // Analog Pin sensor is connected
#define LEDR 6 //Led
#define LEDG 7//Led
#define fan 8
dht11 dhtObject;
String AP = "	Kavinda 4G";       // AP NAME
...
int alarm;//alram variable for the method to method
 ...
 void sms()
{
  ...
  delay(1000);
  mySerial.println("AT"); //Once the test is successful, it will back to OK
  updateSerial();
